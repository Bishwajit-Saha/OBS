...
<table cellpadding="0" cellspacing="0" id="content1"><tr align="justify">
	<td class="con" valign="top">
    	<div id="heade1"><h1>NetBanking</h1></div>
    ...
    <td class="con" valign="top">
        ...
        <p> To access a financial institution's online banking facility, a customer with internet access would need to register with the institution for the service, and set up a password and other credentials for customer verification. The credentials for online banking is normally not the same as for telephone or mobile banking. Financial institutions now routinely allocate customers numbers, whether or not customers have indicated an intention to access their online banking facility.</p>

</p>
    </td>
    
    <td class="con" valign="top">
    	<div id="heade3"><h1>LoanAdvice</h1></div>
        <p>While technology has altered the way loans are being disbursed, the canons of prudent borrowing remain unchanged. It still doesn't make sense to borrow if you don't need the money. Or take a long-term loan only to enjoy the tax benefits available on the interest you pay. Our expert advice lists out such immutable rules of borrowing that potential customers must keep in mind. Follow them and you will never find yourself enslaved by debt. </p>
...
The Bank is actively involved since 2017 in non-profit activity called Community Services Banking. All our branches and administrative offices throughout the country sponsor and participate in large number of welfare activities and social causes. Our business is more than banking because we touch the lives of people anywhere in many ways.</p>
    ...
    <td width="299" valign="top">
        ...
        <h2>Mar. 24, 2017.</h2>
        <p>RBI left the Repo rate unchanged at 6.25 per cent despite lowering its inflation outlook and GDP growth projections. </p><br>
        <div class="img"><img src="images/globe_16.gif" alt="Business"></div>
        <h2>Mar. 25, 2017.</h2>
        <p>Airtel Payments Bank- a joint venture between Bharti Airtel and Kotak Mahindra Bank  offers you an interest rate of 7.25 per cent on their savings account.</p>
